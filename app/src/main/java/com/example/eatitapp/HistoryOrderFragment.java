...
import com.example.eatitapp.Adapter.OrderNoEditAdapter;
...
public class HistoryOrderFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        tbOrder.orderByChild("status").equalTo("Completed").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                OrderNoEditAdapter adapter = new OrderNoEditAdapter(getContext());
